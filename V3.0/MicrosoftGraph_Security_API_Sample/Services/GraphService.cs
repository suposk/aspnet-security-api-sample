...
namespace MicrosoftGraph_Security_API_Sample.Services
{
    public class GraphService : IGraphService
    {
        ...
        public async Task<UserAccountDevice> GetUserDetailsAsync(string principalName, bool populatePicture = false, bool populateManager = false, bool populateDevices = false)
        {
            try
            {
